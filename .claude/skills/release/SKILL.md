...
Then watch the publish workflow at https://github.com/eccenca/cmem-plugin-loopwf/actions and confirm the
new version appeared on [PyPI](https://pypi.org/project/cmem-plugin-loopwf/).
